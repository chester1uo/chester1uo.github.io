...
<div class="win98-acrobat">
  ...
  <div class="win98-toolbar">
    ...
    <button class="win98-toolbar-btn" title="Zoom tool" disabled>
    ...
    <button class="win98-toolbar-btn" title="Select text" disabled>
      <svg viewBox="0 0 20 20"><text x="10" y="14" font-family="'Times New Roman', serif" font-size="11" text-anchor="middle" fill="#000">abc</text></svg>
    </button>
    <span class="win98-toolbar-sep"></span>
    <button class="win98-toolbar-btn" title="First page" disabled>
      <svg viewBox="0 0 20 20"><rect x="4" y="4" width="2" height="12" fill="#000"/><polygon points="16,4 8,10 16,16" fill="#000"/></svg>
    </button>
    <button class="win98-toolbar-btn" title="Previous page" disabled>
      <svg viewBox="0 0 20 20"><polygon points="14,4 6,10 14,16" fill="#000"/></svg>
    </button>
    <button class="win98-toolbar-btn" title="Next page" disabled>
      <svg viewBox="0 0 20 20"><polygon points="6,4 14,10 6,16" fill="#000"/></svg>
    </button>
    <button class="win98-toolbar-btn" title="Last page" disabled>
